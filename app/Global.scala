...
import repository.Exceptions.{NoSuchFavoriteFoundException, DuplicateException, NoSuchRecipeException}
  ...
  override def onError(request: RequestHeader, ex: Throwable) = {
    Future {
      ex.getCause match {
        ...
        case e: DuplicateException => Conflict(Json.obj("ok" -> false, "message" -> Json.toJson(e.getMessage)))
        case e: NoSuchFavoriteFoundException => NotFound(Json.obj("ok" -> false, "message" -> Json.toJson(e.getMessage)))
